...
- **This file is over the ~50KB archive threshold, and the split is deferred on a
  ...
  **Re-measured 2026-08-26 after `fix/release-workflow`: 130,470 total / 51,222
  completed = 39%. Re-measured again 2026-08-27 on `chore/packaging-and-docs`:
  198,782 total / 81,980 completed = 41%.** The three figures above sit between 39%
  and 41% while the file grew from 98KB to 194KiB — the parenthetical below is a
  fourth, older and higher, and it is what the band is measured against. That is the
...
- **`TODOS.md` — this file, ~194 KiB (198,782 bytes, measured 2026-08-27) and an index
  of every known-unfixed gap — ships to every `/plugin install`.** (forgeward gate,
  chore/packaging-and-docs, 2026-08-27)
